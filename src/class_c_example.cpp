...
static uint8_t network_address[] = { 0x26, 0x01, 0x1E, 0xA6 };
static uint8_t network_session_key[] = { 0x09, 0x01, 0x51, 0x8D, 0x79, 0x29, 0xD6, 0x64, 0xE1, 0xEB, 0x43, 0xD1, 0x14, 0xC8, 0x11, 0x3c };
static uint8_t data_session_key[] = { 0xE6, 0x1B, 0x2B, 0x39, 0x02, 0x94, 0x93, 0xA0, 0x7B, 0x49, 0xF1, 0xED, 0xF4, 0x80, 0x10, 0x3c };
...
int main() {
    ...
    logInfo("Whu? freq=%d rxDr=%d\n", dot->getRxFrequency(), dot->getRxDataRate());

    dot->setRxFrequency(869525000);
    dot->setRxDataRate(mDot::SF_9);
...
// #endif
        ...
        // printf("Set RX Window open\n");
        dot->openRxWindow(30000, 10);
        // printf("Done RX Window open\n");
